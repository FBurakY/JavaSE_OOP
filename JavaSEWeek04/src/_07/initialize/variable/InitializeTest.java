...
public class InitializeTest {
	...
	public String toString() {
		return "InitializeTest [intVar=" + intVar + ", longVar=" + longVar + ", doubleVar=" + doubleVar + ", floatVar="
				+ floatVar + ", strVar=" + strVar + ", peson=" + peson + ", intArray=" + Arrays.toString(intArray)
				+ ", intArrayElement=" + Arrays.toString(intArrayElement) + ", boolVar=" + boolVar + "]";
	}
